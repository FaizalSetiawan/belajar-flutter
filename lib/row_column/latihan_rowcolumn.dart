            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  fit: BoxFit.cover,
                  image: AssetImage('assets/images/faizal.jpg'), // Replace with your profile image asset
                ),
              ),
            ),
            _buildInfoBox(
              icon: Icons.person,
              text: 'Fullname: M Faizal S',
            ),
            _buildInfoBox(
              icon: Icons.email,
              text: 'Email: faizalsetiawan@gmail.com',
            ),
            _buildInfoBox(
              icon: Icons.location_on,
              text: 'Address: Jln Perumahan 2',
            ),
            _buildInfoBox(
              icon: Icons.star,
              text: 'Skills: Laravel, Flutter, Java',
            ),
            SizedBox(height: 20),
            Row(
